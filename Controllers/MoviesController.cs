...
namespace CalebMovie.Controllers
{
    public class MoviesController : Controller
    {
        private readonly CalebMovieContext _context;

        public MoviesController(CalebMovieContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string movieGenre, int? movieYear, string searchString)
        {
            ...
            {
                return Problem("Entity set 'CalebMovieContext.Movie' is null.");
            }
